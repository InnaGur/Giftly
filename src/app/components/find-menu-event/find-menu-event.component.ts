...
@Component({
  selector: 'giftly-find-menu-event',
  templateUrl: './find-menu-event.component.html',
  styleUrls: ['./find-menu-event.component.scss']
})
export class FindMenuEventComponent implements OnInit {
